...
final class ValidateCsvTest extends PHPUnit
{
    ...
    public function testValidateOneFileNegativeTable(): void
    {
        ...
        $expected = <<<'TXT'
            ...
            | 6    | 0:Name           | length_min       | The length of the "Carl" is 4, which is less than the expected "5"                     |
            | 11   | 0:Name           | length_min       | The length of the "Lois" is 4, which is less than the expected "5"                     |
            | 1    | 1:City           | ag:is_unique     | Column has non-unique values. Unique: 9, total: 10                                     |
            | 5    | 2:Float          | num_max          | The number of the "74605.944" is 74605.944, which is greater than the expected "74605" |
    ...
    public function testValidateOneFileNegativeText(): void
    {
        ...
        $expected = <<<'TXT'
            ...
            "length_min" at line 6, column "0:Name". The length of the "Carl" is 4, which is less than the expected "5".
            "length_min" at line 11, column "0:Name". The length of the "Lois" is 4, which is less than the expected "5".
            "ag:is_unique" at line 1, column "1:City". Column has non-unique values. Unique: 9, total: 10.
            "num_max" at line 5, column "2:Float". The number of the "74605.944" is 74605.944, which is greater than the expected "74605".
    ...
    public function testValidateManyFilesNegativeTextQuick(): void
    {
        ...
        $expectedFull = <<<'TXT'
            ...
            (1/3) Invalid file: ./tests/fixtures/batch/demo-1.csv
            "ag:is_unique" at line 1, column "1:City". Column has non-unique values. Unique: 1, total: 2.
            "num_max" at line 3, column "2:Float". The number of the "74605.944" is 74605.944, which is greater than the expected "74605".
            "allow_values" at line 3, column "4:Favorite color". Value "blue" is not allowed. Allowed values: ["red", "green", "Blue"].
            
            (2/3) Invalid file: ./tests/fixtures/batch/demo-2.csv
            "length_min" at line 2, column "0:Name". The length of the "Carl" is 4, which is less than the expected "5".
            "length_min" at line 7, column "0:Name". The length of the "Lois" is 4, which is less than the expected "5".
