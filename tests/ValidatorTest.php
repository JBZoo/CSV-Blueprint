...
final class ValidatorTest extends PHPUnit
{
    ...
    private const CSV_COMPLEX          = __DIR__ . '/fixtures/complex_header.csv';
    ...
    public function testNotEmptyMessage(): void
    {
        ...
        isSame('Error "not_empty" at line 18, column "integer (0)". Value is empty.', $csv->validate()[0]);
    }

    public function testNoName(): void
    {
        $csv = new CsvFile(self::CSV_COMPLEX, $this->getRule(null, 'not_empty', true));
        isSame('Property "name" is not defined for column id=0 in schema: _custom_array_', $csv->validate()[0]);
    }
    ...
    public function testMin(): void
    {
        ...
        $csv = new CsvFile(self::CSV_COMPLEX, $this->getRule('seq', 'min', 10));
        isSame('Error "min" at line 1, column "seq (0)". Value "1" is less than "10".', $csv->validate()[0]);
    }
