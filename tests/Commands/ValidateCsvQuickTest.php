...
final class ValidateCsvQuickTest extends TestCase
{
    public function testEnabled(): void
    {
        $expectedFull = <<<'TXT'
            ...
            Check schema syntax: 1
              (1/1) Issues: 1 in ./tests/schemas/demo_invalid.yml
                "is_float", column "2:Float". Value "Qwerty" is not a float number.
                
            
            CSV file validation: 3
            Schema: ./tests/schemas/demo_invalid.yml
              (1/3) Issues: 1 in ./tests/fixtures/batch/demo-1.csv; Size: 123.34 MB
    ...
    public function testDisabled(): void
    {
        $expectedFull = <<<'TXT'
            ...
            CSV file validation: 3
            Schema: ./tests/schemas/demo_invalid.yml
              (1/3) Issues: 5 in ./tests/fixtures/batch/demo-1.csv; Size: 123.34 MB
                "allow_extra_columns" at line 1. Column(s) not found in CSV: "wrong_column_name".
              ...
              (2/3) Issues: 7 in ./tests/fixtures/batch/demo-2.csv; Size: 123.34 MB
                "allow_extra_columns" at line 1. Column(s) not found in CSV: "wrong_column_name".
              ...
              (3/3) Issues: 1 in ./tests/fixtures/batch/sub/demo-3.csv; Size: 123.34 MB
                "allow_extra_columns" at line 1. Column(s) not found in CSV: "wrong_column_name".
